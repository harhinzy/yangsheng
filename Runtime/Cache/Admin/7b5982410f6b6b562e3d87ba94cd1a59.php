...
<body>
    ...
    <div class="header">
        ...
        <!-- 用户栏 -->
        <ul>
            <li style="display: inline-block;max-width: 400px;color: #FFF; margin-right: 10px;padding-right:5px;  overflow: hidden" class="manager user-bar ">
                你好，<em title="<?php echo session('user_auth.username');?>"><?php echo session('user_auth.username');?></em></li>
        </ul>
        <div class="user-bar">
            <a href="javascript:;" class="user-entrance"><i class="icon-user"></i></a>
            <ul class="nav-list user-menu hidden">
               <!-- <li><a href="<?php echo U('User/edit');?>">修改个人资料</a></li>-->
    ...
    <script type="text/javascript" src="/yangsheng/Public/static/layer/layer.js"></script>
    <script type="text/javascript" src="/yangsheng/Public/Admin/js/common.js"></script>
    <script type="text/javascript" src="/yangsheng/Public/Admin/js/app.js"></script>
    <script type="text/javascript">
        +function(){
...
<script type="text/javascript" src="/yangsheng/Public/static/qtip/jquery.qtip.min.js"></script>
<link rel="stylesheet" type="text/css" href="/yangsheng/Public/static/qtip/jquery.qtip.min.css" media="all">

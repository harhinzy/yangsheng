...
<body>
        ...
        <div class="tab-content">
            ...
            <form id="form" action="<?php echo U('edit');?>" method="post" class="form-horizontal">
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" name="title" class="text input-mid" value="<?php echo ($data['title']); ?>"></div>
                </div>
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        ...
                        <input type="hidden" class="pro_img" value="<?php echo ($data['cover_id']); ?>"/>

                        <div class="upload-pre" style="padding-top: 5px">
                            <?php if(!empty($data["cover_id"])): ?><div class="good_img"><img src="<?php echo (get_cover($data['cover_id'],'path')); ?>"/></div><?php endif; ?>
                        </div>
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" name="description" class="text input-mid"><?php echo ($data['description']); ?></div>
                ...
                <div class="form-item cf">
                    ...
                    <input type="hidden" name="category_id" value="<?php echo I('get.id');?>"/>
                </div>
    ...
    <script type="text/javascript">
        //导航高亮
        //  highlight_subnav("<?php echo U('Video/index');?>");
